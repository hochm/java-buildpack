...
module JavaBuildpack::Util
  ...
  class DownloadCache
    ...
    #    the same item. Note that the lock is a file lock acquired on behalf of the process, so it does not synchronise
    ...
    def get(uri)
      ...
      file_cache.lock_exclusive do |locked_file_cache|
